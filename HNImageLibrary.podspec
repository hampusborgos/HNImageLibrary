#
# Be sure to run `pod spec lint HNImageLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of HNImageLibrary
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Hampus Joakim Nilsson" => "mail@hjnilsson.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Hampus Joakim Nilsson', 'other author'
